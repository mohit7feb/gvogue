...
<body class="bg-body" style="background-color:#13110b !important" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%"
              ...
              <div class="col-md-4">
                <div class="navbar-collapse order-1 order-lg-1" id="navbarMenu">
                  <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                      <a class="nav-link pe-4" style="color:white" href="index.php">Home</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link pe-4" style="color:white" href="about.php">About</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link pe-4" style="color:white" href="contact.php">Contact</a>
                    </li>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
          <div class="icon-box text-center">
            ...
            <div class="icon-box-content">
              <h4 class="fw-3 fw-bold text-capitalize">Beauty Care</h4>
              <p>Right from Skincare, Makeup, Nails &amp; Lashes, Hair care, and grooming, our Beauty Industry has truly grown and evolved over the years.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
          <div class="icon-box text-center">
            ...
            <div class="icon-box-content">
              <h4 class="fw-3 fw-bold text-capitalize">Body Treatments</h4>
              <p>Body care is booming. It’s a fact you’re probably well aware of, even if you don’t have access to the hard marketing data. Launch after launch, the skincare</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
          <div class="icon-box text-center">
            ...
            <div class="icon-box-content">
              <h4 class="fw-3 fw-bold text-capitalize">Massages</h4>
              <p>With our everyday busy schedule, getting a face massage from a salon may sound like a luxury. Getting parlor appointments and trying to keep</p>
            </div>
          </div>
        </div>
      ...
      <div class="row align-items-center g-md-5">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 ps-5">
          <div class="p-1">
            ...
            <p>The company’s products offer greater product efficacy and stability over its use, enabling customers to choose a product that can deal with their skin type and is also environmentally sustainable.</p>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6">
          ...
          <ul class="menu-list list-unstyled d-flex justify-content-between">
            ...
            <li class="pb-2">
              <a href="about.php" style="color:white !important;">About</a>
            </li>
            <!-- <li class="pb-2">
              <a href="#">Shop</a>
            </li>
  ...
  <div class="footer-bottom text-center border-top pt-3">
    <p>© 2024 Copyright <a href="#" class="fw-bold" style="color:white !important;"> Glory Vogue</a>. All rights reserved
    </p>
  </div>
